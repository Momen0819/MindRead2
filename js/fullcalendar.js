	...
	var cal = $('#fullcalendar').fullCalendar({
		theme: true,
//         locale: 'ar',
		editable: true,// make true if u want to make it editable
		droppable: true,// make true if u want to make it droppable
 ...
 'الخميس', 'الجمعة', 'السبت'],
        dayNamesShort: ['الأحد', 'الإثنين', 'الثلاثاء', 'الأربعاء',
 'الخميس', 'الجمعة', 'السبت'],
         monthNames: ['يناير', 'فبراير', 'مارس', 'إبريل', 'مايو', 'يونيه', 'يوليه',
 'اغسطس', 'سبتمبر', 'اكتوبر', 'نوفمبر', 'ديسمبر'],
        monthNamesShort: ['يناير', 'فبراير', 'مارس', 'إبريل', 'مايو', 'يونيه', 'يوليه',
 'اغسطس', 'سبتمبر', 'اكتوبر', 'نوفمبر', 'ديسمبر'],
